...
class VoxelMovement:
    ...
    def _get_reference_vector(self, idxmin, match_vec, labels):
    ...
    def _run_frame(self, t, match):
        ...
        ref_vecs = self._get_reference_vector(idxmin, match_vec, labels)
        ref_subtracted_vecs = match_vec - ref_vecs
