...
class ImInfo:
    ...
    def _set_output_filepaths(self):
        ...
        self.path_im_label_tips = os.path.join(self.output_images_dirpath,
                                               f'ch{self.ch}-label_tips-{self.filename}.tif')
        self.path_im_label_junctions = os.path.join(self.output_images_dirpath,
                                                    f'ch{self.ch}-label_junctions-{self.filename}.tif')
        self.path_im_node_types = os.path.join(self.output_images_dirpath,
                                               f'ch{self.ch}-node_types-{self.filename}.tif')
...
if __name__ == "__main__":
    ...
    if visualize:
        ...
        viewer.add_image(loaded_file, name='memmap',
