...
if platform.system() == 'Windows':
    top_dir = r'D:\test_files\nelly\20230330-AELxKB-SKOV3_CD81KO-mScarlet_LAMP1'
    csv_path = os.path.join(top_dir, '20230502-133440-ch_0-track_stats.csv')
    save_path = top_dir
else:
...
remove_cols = ['track_num', 'file_num', 'file_name', 'sample_type',
               ]
now = datetime.now()
...
df['sample_type'] = df['file_name'].apply(lambda x: 'PQLC2_KO' if 'PQLC2_KO' in x else 'Ctrl')
